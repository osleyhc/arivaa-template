  ...
  return (
    <View style={[styles.container]}>
      <Text style={[styles.description]}>
        The Select component is used to create drop down list options for the
        user. It provides options in a drop-down menu or picker.
      </Text>
      <View style={[styles.section]}>
        <Text style={[styles.title]}>Select Modal</Text>
        <Select data={getData(5)} onChange={onChange.bind(this)} type="modal" />
      </View>
      <View style={[styles.section]}>
