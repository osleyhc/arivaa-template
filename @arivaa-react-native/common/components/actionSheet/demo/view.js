...
var view = function () {
  ...
  return (
    <View style={[styles.container]}>
      ...
      >
        Action sheet is normally used to allow user to choose a action from a
        list of actions. We allow both native and our customly designed action
        sheets to choose from.
      </Text>
      <Text style={[styles.description]}>
        You can either call Actionsheet Programatically or use it as a
        component.
      </Text>
      ...
      <View style={[styles.section]}>
        <Text style={[styles.title]}>
          Custom Trigger using "trigger" option
        </Text>
        <ArivaaActionSheet
          title="This is Title"
          message="Testing New Message"
      ...
      <View style={[styles.section]}>
        ...
        <Text style={[styles.message]}>
          ( If you intend to use button as custom trigger, Use triggerProps else
          pass a custom trigger using trigger option )
        </Text>
        <ArivaaActionSheet
          title="This is Title"
          message="Testing New Message"
      ...
      <View style={[styles.section]}>
        ...
        <Text style={[styles.message]}>
          (Useful in case scenarios like inside React Native Modal where action
          sheet can not be put above modal)
        </Text>
        <ModalTrigger
          content={
            <View
          ...
          modalProps={{
            secondaryContent: (
              <ArivaaActionSheetComponent
                ref={(ref) => (this.actionsheet = ref)}
              />
            ),
          }}
        >
          <Button type="bordered" text="Check Action Sheet in Modal" />
        </ModalTrigger>
      </View>
    </View>
  );
