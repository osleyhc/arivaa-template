  ...
  return (
    <View style={[styles.container]}>
      <Text style={[styles.description]}>
        Icons are graphical content used to add more information to almost
        anything. We provide a big library of icons and support almost every
        vector supported by expo or react native.
      </Text>
      <View>
        <ExternalLink link="https://icons.expo.fyi/">
          <Text style={[styles.message]}>Click here To view all icons.</Text>
        </ExternalLink>
      </View>
