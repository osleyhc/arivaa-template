              ...
              <View style={[styles.navigationItem, propStyles.menuItem]}>
                {item.icon ? (
                  <Icon
                    ...
                    style={[
                      ...
                      propStyles.menuItemIcon,
                      active
                        ? [styles.active, propStyles.menuItemActive]
                        : null,
                    ]}
                    {...item.iconProps}
                  />
                ...
                {getReactNode(item.content, {
                  style: [
                    ...
                    propStyles.menuItemText,
                    active ? [styles.active, propStyles.menuItemActive] : null,
                  ],
                })}
              </View>
            </Link>
