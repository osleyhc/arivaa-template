  ...
  return (
    <View style={[styles.container]}>
      ...
      <View style={[styles.section]}>
        <Text style={[styles.title]}>Primary Large Button1</Text>
        <ArivaaButton type="primary" size="large" style={[styles.button]}>
          Primary
        </ArivaaButton>
      </View>
      <View style={[styles.section]}>
        <Text style={[styles.title]}>Primary Small Button</Text>
        <ArivaaButton type="primary" size="small" style={[styles.button]}>
          Primary
        </ArivaaButton>
      </View>
      <View style={[styles.section]}>
      ...
      <View style={[styles.section]}>
        ...
        <ArivaaButton type="bordered" size="large" text={'Bordered'} />
      </View>
      <View style={[styles.section]}>
        ...
        <ArivaaButton
          type="rounded"
          size="large"
          text={<Icon name={'ios-search'} size={25} color="#fff" />}
