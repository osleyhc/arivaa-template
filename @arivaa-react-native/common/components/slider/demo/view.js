  ...
  return (
    <View style={[styles.container]}>
      <Text style={[styles.description]}>
        The Slider component lets users select a value from a range of values by
        moving the slider knob. We support a slider which can be customized to
        suit any scenario be it colors, be it animations.
      </Text>
      ...
      <View style={[styles.section]}>
        ...
        <Slider type="range" onChange={this.onChange.bind(this)} />
      </View>
      <View style={[styles.section]}>
        ...
        />
        <Slider thumbImage={Diamond} onChange={this.onChange.bind(this)} />
      </View>
      <View style={[styles.section]}>
