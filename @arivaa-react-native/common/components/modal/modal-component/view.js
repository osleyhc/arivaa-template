...
import { getNavigationEvents } from '../../navigation';
...
var view = function () {
  ...
  if (contentOffsetTop || !modalId) {
    modalContentStyles.paddingTop =
      typeof contentOffsetTop === 'number'
        ? contentOffsetTop
        : Platform.OS === 'ios'
        ? 70
        : 50;
  ...
  if (contentOffsetBottom || !modalId) {
    modalContentStyles.paddingBottom =
      typeof contentOffsetBottom === 'number' ? contentOffsetBottom : 50;
  }
  return (
    <ModalBox
      isOpen={visible}
      ...
      {!hideCloseButton ? (
        ...
        >
          <Icon
            type="feather"
            name="x"
            style={[styles.closeIcon, propStyles.closeIcon]}
          />
        </TouchableHighlight>
      ) : null}
      {useScrollView === false ? (
        ...
        <ScrollView
          ...
          contentContainerStyle={[
            styles.flexOne,
            scrollViewProps ? scrollViewProps.style : null,
            propStyles.scrollView,
          ]}
        >
          <View
            style={[
