...
var view = function () {
  ...
  if (this.isString(headerContent)) {
    headerContent = (
      <Text style={[styles.headerText, propStyles.headerText]}>
        {headerContent}
      </Text>
    );
  }
  ...
  if (this.isString(bodyContent)) {
    bodyContent = (
      <Text style={[styles.bodyText, propStyles.bodyText]}>{bodyContent}</Text>
    );
  }

  if (this.isString(footerContent)) {
    footerContent = (
      <Text style={[styles.footerText, propStyles.footerText]}>
        {footerContent}
      </Text>
    );
  }
    ...
    <View style={propStyles.container}>
      <Card style={[styles.card, style, propStyles.card]}>
        ...
        <Card.Body
          style={[
            styles.cardBody,
            !headerContent ? styles.noHeader : null,
            propStyles.body,
          ]}
        >
          {bodyContent}
