...
import ArivaaCard from '../../card/main';
  ...
  return (
    <View style={[styles.container]}>
      <Text style={[styles.description]}>
        ...
        options for headers and footers, a wide variety of content.We provide a
        ready made image and list cards since they are most commonly used. Even
        if you want to create your own custom card, You can use our card
        component.
      </Text>
      ...
      <View style={[styles.section]}>
        <Text style={[styles.title]}>
          Image Card With a Overlay (with title and subtitle) and a Footer
        </Text>
        <ImageCard
          image={getRandom('image')}
          overlay={true}
