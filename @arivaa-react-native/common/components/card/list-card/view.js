      ...
      {data
        ? data.map((item, index) => {
            return (
              <Link
                key={index}
                style={propStyles.listItemContainer}
                onPress={this.onItemClick.bind(this, item, index)}
              >
                <View
                  style={[
                    styles.item,
                    data.length === index + 1 ? styles.lastItem : null,
                    propStyles.listItem,
                  ]}
                >
                  <Image
                  ...
                  <View style={[styles.text, propStyles.listItemTextContainer]}>
                    <Text style={[styles.title, propStyles.listItemTitle]}>
                      {item.title}
                    </Text>
                    <Text
                      style={[styles.subTitle, propStyles.listItemSubTitle]}
                    >
                      {item.subTitle}
                    </Text>
                  </View>
