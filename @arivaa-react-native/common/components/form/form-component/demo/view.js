...
var view = function () {
  ...
  const formElements = [
    ...
    {
      name: 'rememberMe',
      customElement: <Checkbox text="Remember Me" />,
    },
  ];
  const formElements2 = [
    {
    ...
    {
      name: 'salary',
      customElement: <Slider type="range" min={1000} max={20000} step={500} />,
      before: (
        <Text style={[styles.label]}>
  ...
  return (
    <View style={styles.container}>
      <Text style={[styles.description]}>
        A Form component will be useful to create any form in an application
        with variety of simple and complex input elements. All our data input
        elements are compatible with this form.
      </Text>
      <View style={[styles.section]}>
        <Text style={[styles.title]}>
          Simple Form with Inputs and Validations
        </Text>
        <Form
      ...
      <View style={[styles.section]}>
        <Text style={[styles.title]}>
          Form with Complex Inputs and Validations
        </Text>
        <Form
