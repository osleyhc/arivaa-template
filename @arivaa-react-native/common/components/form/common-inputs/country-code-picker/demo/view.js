...
import CountryCodePicker from '../main';

var view = function () {
  return (
    <View style={[styles.container]}>
      <Text style={[styles.description]}>
        Country Code Picker (CCP) is a component which provides an easy way to
        search and select country phone code ( national code ) for the telephone
        number.
      </Text>
      ...
      <View style={[styles.section]}>
        <Text style={[styles.title]}>
          Select Country Code With Custom Formatters
        </Text>
        <CountryCodePicker
          type="picker"
          labelFormatter={(obj) => {
