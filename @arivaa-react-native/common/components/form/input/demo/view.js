  ...
  return (
    <View style={[styles.container]}>
      <Text style={[styles.description]}>
        An Input component allows the user to enter any data in a text input. In
        Arivaa we have provided different type of inputs with varying data type.
        When a user will try to input in these inputs, Keyboards of specific
        type will be used on mobile e.g for Number input, only number keyboard
        will be shown.
      </Text>
