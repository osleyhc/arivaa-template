  ...
  return (
    <View style={styles.container}>
      <Text style={[styles.description]}>
        An Image Picker component is useful in selecting images from the phone's
        library or taking a photo with the camera.
      </Text>
      <View style={styles.section}>
        <Text style={styles.title}>Default Image Picker</Text>
        <Text style={styles.message}>
          ( In default Image Picker you don't need to control display of
          selected image and opening of an image picker )
        </Text>
        <ImagePicker
          imageWidth={100}
          imageHeight={100}
      ...
      <View style={styles.section}>
        ...
        <Text style={styles.message}>
          ( You can control the triggering of image picker and display of image
          selected )
        </Text>
