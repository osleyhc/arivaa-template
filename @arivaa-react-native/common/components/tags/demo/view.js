  ...
  return (
    <View style={styles.container}>
      <Text style={[styles.description]}>
        A Tag component will help users to categorize the content. In Arivaa we
        are providing different types of tags like Read only Tags, Single and
        Multi Select Tags and so on.
      </Text>
      <View style={[styles.section]}>
        <View style={[styles.section]}>
          <Text style={[styles.title]}>Read only Tags</Text>
          <Tags data={data} readOnly={true} />
        </View>
        <View style={[styles.section]}>
